...
class ThreeApp {
  ...
  init() {
   ...
   moveMoon() {
    ...
    if (t <= 1) {
        // 始点から始点までの大円を一周
        this.moon.position.lerpVectors(this.startPoint, this.startPoint, t);
      } else {
        // 始点から終点まで移動
        this.moon.position.lerpVectors(this.startPoint, this.endPoint, t - 1);
      }
