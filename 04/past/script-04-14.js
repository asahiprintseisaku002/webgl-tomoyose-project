...
class ThreeApp {
  ...
  static CAMERA_PARAM = {
    ...
    near: 0.1,
    far: 300.0,
    position: new THREE.Vector3(0.0, -2, 14.0),
...
for (let g = 0; g < 4; ++g) {
    ...
    this.gridHelper2.position.set(0.0, 5, 0.0);
    this.gridHelper2.rotation.set(-0.1, 0.0, 0.0);
  ...
  render() {
    ...
    //this.gridHelper2.position.copy(this.camera.position);
    /*
    this.gridHelper.position.z -= 1;

    if (this.gridHelper.position.z < -80) {
