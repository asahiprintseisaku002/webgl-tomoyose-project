...
class App {
  ...
  animateProgress() {
    //console.log('Animating Progress:', this.progress, ' -> ', this.targetProgress);

    // progressがtargetProgressに到達するまで進行
    if (this.progress < this.targetProgress) {
        this.progress += 0.01;  // 進行速度を調整

        // progressがtargetProgressを超えたら停止
        if (this.progress >= this.targetProgress) {
