  ...
  */
  ...
  animate(time) {
    ...
    if (elapsedTime >= duration) {
      ...
      this.gl.uniform1i(this.uniformLocation.currentTextureUnit, (this.gl.getUniform(this.program, this.uniformLocation.currentTextureUnit) + 1) % 2);
      this.startTime = Date.now(); // startTimeをリセット
      elapsedTime = 0;
    }
